...
function DialogOverlay({
  ...
  return (
    <DialogPrimitive.Overlay
      ...
      className={cn(
        'fixed inset-0 z-50 bg-background/45',
...
function DialogContent({
  ...
  classNames?: Partial<Record<'close' | 'overlay', string>>
  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          'fixed top-[50%] left-[50%] gap-4 p-6 z-50 grid w-full max-w-[calc(100%-2rem)] sm:max-w-lg rounded-lg border shadow-lg duration-200 translate-x-[-50%] translate-y-[-50%]',
